...
Plans:
- [ ] 11-01-PLAN.md — xrdp config (xrdp.ini TLS :3389 + cert), sesman.ini Xorg backend, PAM → password-auth, GNOME startwm.sh + colord polkit, systemd units enabled, role wired before hardening, RDP-13 bake assert (RDP-04/05/06/07/08/13)
...
| 11. Service Config, PAM, Session + Bake Verification | v3.2 | 0/1 | Planned | - |
