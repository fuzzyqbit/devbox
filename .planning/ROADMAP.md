...
- [x] **Phase 9: Jupyter Operator Surface + Docs** — Surface the on-demand Jupyter flow in `./run status` and document the `./run jupyter` + manual `:8888` SSM port-forward access path (completed 2026-06-02)
