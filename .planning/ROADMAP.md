...
**Success Criteria** (what must be TRUE):
  ...
  5. DCV survives the hardened baseline: SELinux relabel leaves the install AVC-clean-capable
     ...
     cert + relabel recipe.
**Plans**: 2 plans
- [ ] 13-01-PLAN.md — `dcv` role: airgap install + dcv.conf (auth=system, QUIC on, :8443) + FIPS cert + oneshot virtual session + colord/PAM + SELinux relabel (DCV-01/02/03/05)
...
| 13. `dcv` Ansible Role | v4.0 | 0/2 | Planned | - |
